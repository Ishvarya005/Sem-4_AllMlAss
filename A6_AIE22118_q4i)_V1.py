...
def main():
    ...
    # For Question 2: Using rest of the Activation Functions
    perceptron_all_activations = Perceptron(activation_func=bipolar_step_func) #change to rest of act_func
    X_train = np.array([[0, 1], [1, 1], [0, 0], [1, 0]])
    y_train = np.array([1, 0, 0, 1])  # XOR gate
